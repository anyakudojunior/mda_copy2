...
meteo = pd.read_csv("Datasets for features\meteo_features_test.csv")
site = pd.read_csv("Datasets for features\count_data_test.csv")
...
#save as a csv
final_merged.to_csv("Datasets for features\merged_data_test.csv", index=False)