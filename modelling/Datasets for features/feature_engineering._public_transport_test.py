...
stops = pd.read_csv("Datasets for features\data_raw\de_lijn_stops_2025_07_01.txt")
...
sites_new.to_csv("Datasets for features\sites_x_pub_transport_test.csv", index=False)